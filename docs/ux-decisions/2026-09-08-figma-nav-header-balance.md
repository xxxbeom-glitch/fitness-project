...
The local component keeps the original visual language but owns the structural rule inside this fitness-project file.
...
- representative `04` and `05` migrated headers render correctly after migration
